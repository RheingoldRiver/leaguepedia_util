...
startat_page = None
print(startat_page)
#startat_page = 'DreamHack Valencia 2015'
this_template = site.pages['Template:TeamRoster/Button'] # Set template
pages = this_template.embeddedin()

SECTION_NAMES = ['Participants', 'Rosters', 'Team Rosters', 'Notable Participants']
MAX_TEAMS = {
	'400' : '2',
	'600' : '3',
	'700' : '4',
...
for page in pages:
	...
	for section in wikitext.get_sections(flat = True):
		if section.filter_headings() and section.filter_headings()[0].title.strip() in SECTION_NAMES:
			...
			if len(lines) > 1 and '{{TeamRoster/Button}}' in lines[1]:
