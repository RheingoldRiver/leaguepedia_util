...
site = EsportsSite('lol') 'apexlegends-esports')  # Set wiki
summary = 'Automated parameter removal'  # Set summary
	...
	if lmt < startat:
		...
		for template in wikitext.filter_templates():
			if template.name.matches('Infobox Player'):
				if template.has('checkboxSharesRole'):
					template.remove('checkboxSharesRole')
